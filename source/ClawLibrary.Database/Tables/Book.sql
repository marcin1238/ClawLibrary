...
(
	...
	[CreatedDate] DATETIMEOFFSET NOT NULL CONSTRAINT [DF_Book_CreatedDate] DEFAULT (SYSDATETIMEOFFSET()),
	[CreatedBy] NVARCHAR(256) NULL,
	[ModifiedDate] DATETIMEOFFSET NULL CONSTRAINT [DF_Book_ModifiedDate] DEFAULT (SYSDATETIMEOFFSET()),
