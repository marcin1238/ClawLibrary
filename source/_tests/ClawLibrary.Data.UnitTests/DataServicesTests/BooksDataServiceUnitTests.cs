...
namespace ClawLibrary.Data.UnitTests.DataServicesTests
{
    ...
    public class BooksDataServiceUnitTests
    {
        ...
        [TestCase("createddate_desc", 1)]
        [TestCase("modifieddate_desc", 1)]
